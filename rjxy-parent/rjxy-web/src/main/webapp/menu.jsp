							...
							<TBODY>
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
										class=span id=table_1Span>＋</SPAN> 评价管理</TD>
								</TR>
								<TR>
									<TD>
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/jsp/student/add.jsp" 
														target=main>－ 新增评价</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/ListStudentServlet"
														target=main>－评价列表</A></TD>
												</TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/jsp/student/expert.jsp"
														target=main>－导出</A></TD>
												</TR>
											</TBODY>
										</TABLE>
